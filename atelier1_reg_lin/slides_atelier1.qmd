...
```{r echo=FALSE}
curve((x-2)^2/5 + 1/x, from=1, to=6, ylim=c(0,6), xlab="Complexité du modèle", ylab="Erreur test", col="blue", lwd=2)
```
...
<details><summary>Réponse</summary>Vrai — c’est l’idée clé de la régression multiple.</details>
